...
sidebar_position: 1
cf_rt: google_sheet_zoho_books_cashflow_report
---

<Gsheet
  src="https://docs.google.com/spreadsheets/d/1v5M0VEmqpHedmV1WUqeSAyCzScEipEyoyC-8gZhPq_w/edit#gid=0"
  type="report"
/>
...
### 1. [Fetch Cashflow statement simple format](/library/jobs/zoho_books/fetch_cashflow_statement/simple_format)
| variable name | set to | comments|
| --- | --- | --- | 
| start_date| YYYY-04-01 | start of the financial year in YYYY-MM-DD format. Typically 1st April |

### 2. [Fetch Cashflow statement database format](/library/jobs/zoho_books/fetch_cashflow_statement/database_format)
