...
### 1. [ Cashflow statement simple format](/library/jobs/zoho_books/fetch_cashflow_statement/simple_format)
| variable name | set to | comments|
| --- | --- | --- | 
| start_date| YYYY-04-01 | start of the financial year in YYYY-MM-DD format. Typically 1st April |

### 2. [ Cashflow statement database format](/library/jobs/zoho_books/fetch_cashflow_statement/database_format)
