...
sidebar_position: 1
cf_rt: google_sheet_zoho_books_pnl_report
---

<Gsheet
  src="https://docs.google.com/spreadsheets/d/139YYuIluOi_iSuKXjo7VVWjqchioN4rpZN4w3LKku2U/edit#gid=2143715470"
  type="report"
/>
...
### 1. [Fetch Profit and Loss simple format](/library/jobs/zoho_books/fetch_pnl/simple_format)
| variable name | set to | comments|
| --- | --- | --- | 
| start_date| YYYY-04-01 | start of the financial year in YYYY-MM-DD format. Typically 1st April |

### 2. [Fetch Profit and Loss database format](/library/jobs/zoho_books/fetch_pnl/database_format)
