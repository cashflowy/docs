...
### 1. [ Profit and Loss simple format](/library/jobs/zoho_books/fetch_pnl/simple_format)
| variable name | set to | comments|
| --- | --- | --- | 
| start_date| YYYY-04-01 | start of the financial year in YYYY-MM-DD format. Typically 1st April |

### 2. [ Profit and Loss database format](/library/jobs/zoho_books/fetch_pnl/database_format)
