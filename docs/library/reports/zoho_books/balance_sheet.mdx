...
### 1. [Fetch Balance sheet simple format](/library/jobs/zoho_books/fetch_balance_sheet_simple_format)
### 2. [Fetch Balance sheet database format](/library/jobs/zoho_books/fetch_balance_sheet_database_format)
