...
### 1. [ Balance sheet simple format](/library/jobs/zoho_books/fetch_balance_sheet/report)
| variable name | set to | comments|
| --- | --- | --- | 
| start_date| YYYY-04-01 | start of the financial year in YYYY-MM-DD format. Typically 1st April |

### 2. [ Balance sheet database format](/library/jobs/zoho_books/fetch_balance_sheet/raw_data)
