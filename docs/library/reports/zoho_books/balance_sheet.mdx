...
title: Balance Sheet
sidebar_position: 1
cf_rt: google_sheet_zoho_books_balance_sheet_report
---
...
### 1. [ Balance sheet simple format](/library/jobs/zoho_books/fetch_balance_sheet/simple_format)
| variable name | set to | comments|
| --- | --- | --- | 
| start_date| YYYY-04-01 | start of the financial year in YYYY-MM-DD format. Typically 1st April |

### 2. [ Balance sheet database format](/library/jobs/zoho_books/fetch_balance_sheet/database_format)
