...
This job fetches Payment Intents from Stripe. A PaymentIntent guides you through the process of collecting a payment from your customer. 
...
### References
- [Payment Intents - stripe API docs](https://docs.stripe.com/api/payment_intents)